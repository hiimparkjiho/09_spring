...
public class Application {
    ...
    * 3. request http 요청을 처리할 때마다 새로운 인스턴스를 생성하고, 요청 처리가 끝나면 인스턴스를 패기한다. 웹 애플리케이션 컨택스트에만 해당된다.
    * 4. session http 세션 당 하나의 인스턴스를 생성하고, 세션이 종료되면 인스턴스를 패기한다. 웹 애플리케이션 컨택스트에만 해당된다.
    * 5. globalSession 전역 세션 당 하나의 인스턴스를 생성하고, 전역 세션이 종료되면 인스턴스를 패기한다. 포털 애플리케이션 컨택스트에만 해당된다.
    * */
