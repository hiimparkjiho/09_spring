...
public class BookService {
    ...
    private final BookDAO bookDAO;  // final이 붙은 경우 @Autowired를 사용할 수 없다.
    ...
    * 위의 코드에서 기본 생성자를 추가로 작성하고 매개변수 생성자에 @Autowired 어노테이션을 생략하게 되면 생성자 주입이 동작하지 않아 오류가 발생된다.
    *
    * 생성자 주입의 장점
    ...
    * - 객체의 불변성을 보장할 수 있다.
    *   - 필드에 'final' 사용 가능하고 객체 생성 이후 의존성을 변경할 수 없어 안전성이 보장된다.
    * - 코드 가독성이 좋다.
